...
const learningSteps = [
  {
    ...
    text: "Simple emoji faces help children practise identifying four basic emotions.",
    icon: <IconEye />,
  },
  {
    number: "02",
...
const emotionChoices = {
  ...
  frustrated: {
    ...
    message: "Naming frustration creates a small pause—and a clearer first step toward asking for support.",
  },
} as const;
...
const siteCopy = {
  en: {
    ...
    emotions: { happy: "Happy", calm: "Calm", sad: "Sad", frustrated: "Frustrated" },
    ...
    learning: {
      ...
      steps: [
        { cue: "Recognize emotions", title: "Recognize", text: "Simple emoji faces help children practise identifying four basic emotions." },
  ...
  th: {
    ...
    emotions: { happy: "มีความสุข", calm: "สงบ", sad: "เศร้า", frustrated: "หงุดหงิด" },
